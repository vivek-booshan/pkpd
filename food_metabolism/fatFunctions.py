...
def fattyacids(t, y, p):
    ...
    dydt[5] = (
        ...
        - p.shared.k_FA_to_AcCoA * y[5]
        - 3 * (p.F.k_FA_to_TG * p.V.fat * y[5] / (Km + y[5] * p.V.fat))**3
        + 3 * p.F.k_TG_to_FA * y[9]
        + p.shared.k_AcCoA_to_FA * y[11]
    )
    return dydt
...
def g6p(t, y, p):
    ...
    dydt[8] = (
        ...
        - p.shared.k_G6P_to_Pyr * y[8]
        + p.shared.k_Pyr_to_G6P * y[10]**2
    )
    return dydt
...
def triglycerides(t, y, p):
    ...
    dydt[9] = (
        + (p.F.k_FA_to_TG * p.V.fat * y[5] / (Km + y[5] * p.V.fat))**3
        - p.F.k_TG_to_FA * y[9]
    )
    return dydt
...
def pyruvate(t, y, p):
    ...
    dydt[10] = (
        + 2 * p.shared.k_G6P_to_Pyr * y[8]
        - 2 * p.shared.k_Pyr_to_G6P * y[10]**2
        - p.shared.k_Pyr_to_AcCoA * y[10]
    )
    return dydt
...
def acetylcoa(t, y, p):
    ...
    dydt[11] = (
        + p.shared.k_Pyr_to_AcCoA * y[10]
        + 8 * p.shared.k_FA_to_AcCoA * y[5]
        + p.shared.k_AA_to_AcCoA * y[7]
        - 8 * p.shared.k_AcCoA_to_FA * y[11]
    )
    return dydt
