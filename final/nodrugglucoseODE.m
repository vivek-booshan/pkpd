function dydt = nodrugglucoseODE(t, y, p)
    ...
    ROS = y(9);
    oxLDL = y(10);
    glucose = y(11);  % New glucose variable
    ...
    dliver_chol = (...
        ...
        + p.glucose.liver_effect * glucose ... % Glucose enhances liver cholesterol synthesis
        ) / p.V.liver;
    ...
    dROS = (...
        ...
        + p.glucose.ROS_effect * glucose ... % Glucose increases ROS
        );
