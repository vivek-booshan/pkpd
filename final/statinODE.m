function dydt = statinODE(t, y, p)
    ...
    dperipheral_chol = (...
        ...
        + p.V.liver * p.liver.LDL.chol * liver_chol * max(1, log(ROS)) ...
        + p.V.liver * p.liver.HDL.chol * liver_chol ... 
        - p.V.peripheral * p.peripheral.LDL.chol * peripheral_chol * max(1, log(liver_statin)) ...
    ...
    dydt = [...
        ...
        dROS; doxLDL; ...
        doral_statin; dstatin; dliver_statin; dclearance_statin ...
        ];
end